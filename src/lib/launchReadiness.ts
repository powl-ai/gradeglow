...
export const manualLaunchChecks: ManualLaunchCheck[] = [
  ...
  {
    id: "legal-hub-placeholders",
    categoryId: "data",
    title: "Legal-Hub-Platzhalter ersetzt",
    description: "Impressum, Datenschutz, Nutzungsbedingungen, Widerruf und Ads-Hinweise vor öffentlicher Beta final prüfen lassen.",
    owner: "Recht",
    priority: "hoch",
  },
  {
  ...
  {
    id: "checkout-redirects-tested",
    categoryId: "monetization",
    title: "Checkout Success/Cancel Rückwege getestet",
    description: "/checkout/success und /checkout/cancel öffnen und später im Payment-Provider als Redirects eintragen.",
    owner: "Technik",
    priority: "mittel",
  },
  {
    id: "manual-payment-entitlement-tested",
    categoryId: "monetization",
    title: "Manuelle Payment-Freischaltung getestet",
    description: "Mit Test-UID in /admin den Preset payment_manual setzen und prüfen, dass Plus ohne Functions aktiv wird.",
    owner: "Beta",
    priority: "hoch",
  },
  {
